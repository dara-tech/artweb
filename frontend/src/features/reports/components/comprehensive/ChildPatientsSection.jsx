        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            ...
            <tbody>
              {/* New Child Patients */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8 font-semibold">អ្នកជំងឺកុមារថ្មី</td>
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-8">Pre-ART កុមារមុន</td>
              ...
              {/* Previous Child ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">កុមារ ART មុន</td>
              ...
              {/* Child Start ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">កុមារចាប់ផ្តើម ART</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-green-600">
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-8">កុមារ Pre-ART ពិនិត្យឡើងវិញ</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-yellow-600">
              ...
              {/* Child Transfer In */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">កុមារផ្ទេរចូល</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-blue-600">
              ...
              {/* Child Lost - No ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">កុមារបាត់បង់ - គ្មាន ART</td>
              ...
              {/* Child Lost - With ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">កុមារបាត់បង់ - មាន ART</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-red-600">
              ...
              {/* Child Death - No ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">កុមារស្លាប់ - គ្មាន ART</td>
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-12">កុមារស្លាប់ - មាន ART</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-gray-600">
              ...
              {/* Child Test Negative */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">កុមារពិនិត្យអវិជ្ជមាន</td>
              ...
              {/* Child Transfer Out */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">កុមារផ្ទេរចេញ</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-blue-600">
              ...
              <tr className="bg-green-100 font-bold">
                <td className="border border-gray-300 p-3 pl-6">សរុបកុមារ</td>
                <td className="border border-gray-300 p-3 text-center text-green-800">
