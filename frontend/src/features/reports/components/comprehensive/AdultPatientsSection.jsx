          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-100">
                <th className="border border-gray-300 p-3 text-left font-semibold">ប្រភេទ</th>
                <th className="border border-gray-300 p-3 text-center font-semibold">ប្រុស</th>
                <th className="border border-gray-300 p-3 text-center font-semibold">ស្រី</th>
                <th className="border border-gray-300 p-3 text-center font-semibold">សរុប</th>
              </tr>
            </thead>
            <tbody>
              {/* New OI This Quarter */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8 font-semibold">ជំងឺឆ្លងថ្មីនេះត្រីមាស</td>
              ...
              {/* Previous Pre-ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">Pre-ART មុន</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-yellow-600">
              ...
              {/* New Lost & Return */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">បាត់បង់ និងត្រលប់មកវិញ</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-orange-600">
              ...
              {/* New Lost & Return ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">បាត់បង់ និងត្រលប់មកវិញ (ART)</td>
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-8">អ្នកជំងឺ ART មុន</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-green-600">
              ...
              {/* Patient Start ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">អ្នកជំងឺចាប់ផ្តើម ART</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-green-600">
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-8">Pre-ART រាប់ពិនិត្យឡើងវិញ</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-yellow-600">
              ...
              {/* Patient Transfer In */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">អ្នកជំងឺផ្ទេរចូល</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-blue-600">
              ...
              <tr className="bg-gray-100">
                <td className="border border-gray-300 p-3 pl-6 font-bold text-gray-700" colSpan="4">
                  ស្ថានភាពអ្នកជំងឺ
                </td>
              </tr>
              ...
              {/* Lost - No ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">បាត់បង់ - គ្មាន ART</td>
              ...
              {/* Lost - With ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">បាត់បង់ - មាន ART</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-red-600">
              ...
              {/* Death - No ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ស្លាប់ - គ្មាន ART</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-gray-600">
              ...
              {/* Death - With ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ស្លាប់ - មាន ART</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-gray-600">
              ...
              {/* Test Negative */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ពិនិត្យអវិជ្ជមាន</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-purple-600">
              ...
              {/* Transfer Out */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ផ្ទេរចេញ</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-blue-600">
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ពិនិត្យ TB - គ្មានរោគសញ្ញា</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-green-600">
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ពិនិត្យ TB - មានរោគសញ្ញា</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-orange-600">
              ...
              {/* Positive Prevent */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ការពារវិជ្ជមាន</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-purple-600">
              ...
              {/* Diagnose TB */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">រោចវិនិយោគ TB</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-red-600">
              ...
              {/* Treat TB */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ព្យាបាល TB</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-green-600">
              ...
              {/* Cotrimoxazole */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">Cotrimoxazole</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-blue-600">
              ...
              {/* Pregnant - New */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">មានផ្ទៃពោះ - ថ្មី</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-pink-600" colSpan="3">
              ...
              {/* Pregnant - Follow-up */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">មានផ្ទៃពោះ - តាមដាន</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-pink-600" colSpan="3">
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-12">មានផ្ទៃពោះ - មិនមានផ្ទៃពោះ</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-pink-600" colSpan="3">
              ...
              {/* Pregnant - Pregnant */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">មានផ្ទៃពោះ - មានផ្ទៃពោះ</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-pink-600" colSpan="3">
              ...
              <tr className="bg-blue-100 font-bold">
                <td className="border border-gray-300 p-3 pl-6">សរុបអ្នកជំងឺពេញវ័យ</td>
                <td className="border border-gray-300 p-3 text-center text-blue-800">
