        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            ...
            <tbody>
              {/* New Exposed Infants */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8 font-semibold">ទារកឆ្លងថ្មី</td>
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-8">Pre-ART ទារកមុន</td>
              ...
              {/* Previous Infant ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">ទារក ART មុន</td>
              ...
              {/* Infant Start ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">ទារកចាប់ផ្តើម ART</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-green-600">
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-8">ទារក Pre-ART ពិនិត្យឡើងវិញ</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-yellow-600">
              ...
              {/* Infant Transfer In */}
              <tr>
                <td className="border border-gray-300 p-3 pl-8">ទារកផ្ទេរចូល</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-blue-600">
              ...
              {/* Infant Lost - No ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ទារកបាត់បង់ - គ្មាន ART</td>
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ទារកបាត់បង់ - មាន ART</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-red-600">
              ...
              {/* Infant Death - No ART */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ទារកស្លាប់ - គ្មាន ART</td>
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ទារកស្លាប់ - មាន ART</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-gray-600">
              ...
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ទារកពិនិត្យអវិជ្ជមាន</td>
              ...
              {/* Infant Transfer Out */}
              <tr>
                <td className="border border-gray-300 p-3 pl-12">ទារកផ្ទេរចេញ</td>
                <td className="border border-gray-300 p-3 text-center font-semibold text-blue-600">
              ...
              <tr className="bg-purple-100 font-bold">
                <td className="border border-gray-300 p-3 pl-6">សរុបទារក</td>
                <td className="border border-gray-300 p-3 text-center text-purple-800">
