...
// Generate a comprehensive workbook script for indicator analysis
function generateWorkbookScript() {
  const scriptContent = `// ART Web Comprehensive Analysis Workbook
...
const scriptContent = generateWorkbookScript();
const outputPath = path.join(__dirname, '../artweb-comprehensive-analysis-workbook.js');

fs.writeFileSync(outputPath, scriptContent);

console.log('✅ Comprehensive workbook script generated successfully!');
console.log(`📄 Saved to: ${outputPath}`);
console.log('');
console.log('📋 Usage Instructions:');
console.log('1. Install dependencies: npm install mysql2');
console.log('2. Set environment variables:');
console.log('   - DB_HOST, DB_PORT, DB_USER, DB_PASSWORD, DB_NAME');
console.log('   - SITE_CODE, START_DATE, END_DATE, OUTPUT_DIR');
console.log('3. Run: node artweb-comprehensive-analysis-workbook.js');
console.log('');
console.log('🔧 The script will:');
console.log('- Connect to your MySQL database');
console.log('- Run all HIV/AIDS indicators');
console.log('- Generate comprehensive analysis results');
console.log('- Save results to JSON file');
console.log('- Display summary in console');